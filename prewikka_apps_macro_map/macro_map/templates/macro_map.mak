...
<div id="settings-modal" class="crud-modal-border crud-modal">
  <div class="custom-modal-header bg-primary">
    <div class="flex justify-between">
      ...
      <div class="cursor-pointer flex align-center" onclick="closeSettingsModal()">
        <svg clip-rule="evenodd" fill-rule="evenodd" fill="white" stroke-linejoin="round"
          stroke-miterlimit="2" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="custom-modal-body">
    <div class="flex flex-col gap-1 wrap">
      ...
      <div class="flex align-center gap-1 pl-1 pr-1">
        <span>Max past positions to display:</span>
        <input type="number" id="past-positions-input" class="modal-input" style="width: 80px;" min="0" value="2">
      </div>
      <hr class="modal-hr">
      <div class="flex flex-col gap-1 wrap">
        <span class="bold text-danger">Data Management</span>
        <div class="flex align-center justify-between pl-1 pr-1">
          <span>Permanently delete all markers and rules:</span>
          <button id="reset-map-button" class="btn btn-danger" type="button" onclick="resetMap()">Reset Map</button>
        </div>
      </div>
      <div class="flex w-100 justify-end mt-1 pl-1 pr-1">
        <button id="save-settings-button" class="btn btn-primary" type="button" onclick="applyGlobalSettings()">Apply Settings</button>
      </div>
    </div>
  </div>
</div>
